...
#include "simpleReprojectionTwoFrameTwoCamFactor.h"

Eigen::Matrix2d SimpleReprojectionTwoFrameTwoCamFactor::sqrt_info;
double SimpleReprojectionTwoFrameTwoCamFactor::sum_t;

SimpleReprojectionTwoFrameTwoCamFactor::SimpleReprojectionTwoFrameTwoCamFactor(
...
bool SimpleReprojectionTwoFrameTwoCamFactor::Evaluate(double const *const *parameters, double *residuals,
...
void SimpleReprojectionTwoFrameTwoCamFactor::check(double **parameters) {
