...
#include "altSimpleReprojectionTwoFrameOneCamFactor.h"
#include <ceres/gradient_checker.h>
#include "pose_local_parameterization.h"

Eigen::Matrix2d AltSimpleReprojectionTwoFrameOneCamFactor::sqrt_info;
double AltSimpleReprojectionTwoFrameOneCamFactor::sum_t;

AltSimpleReprojectionTwoFrameOneCamFactor::AltSimpleReprojectionTwoFrameOneCamFactor(const Eigen::Vector3d &_pts_i,
...
double AltSimpleReprojectionTwoFrameOneCamFactor::ComputeResidual(double const *pPi, double const *pPj) {
...
void AltSimpleReprojectionTwoFrameOneCamFactor::UpdateWeight(double const *pPi, double const *pPj, double &weight,
                                                             double fixed_shape) {
  Eigen::Vector3d Pi(pPi[0], pPi[1], pPi[2]);
  Eigen::Quaterniond Qi(pPi[6], pPi[3], pPi[4], pPi[5]);
  ...
  residual = (pts_camera_j / dep_j).head<2>() - pts_j.head<2>();
  residual = sqrt_info * residual;
  double c_param_2 = fixed_shape * fixed_shape;
}

bool AltSimpleReprojectionTwoFrameOneCamFactor::Evaluate(double const *const *parameters, double *residuals,
...
void AltSimpleReprojectionTwoFrameOneCamFactor::check(double **parameters) {
